...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_menuBurger__WEBPACK_IMPORTED_MODULE_1__["default"])('.menu', '.menu-link', '.hamburger', true);
...
var menuBurger = function menuBurger(menu, item, target) {
  ...
  hamburger.addEventListener('click', function () {
    ...
    menuBody.classList.toggle('active'); // если необходимо блокировать прокрутку фона (атрибут lock указать true)
  ...
  menuItem.forEach(function (item) {
    item.addEventListener('click', function () {
      if (hamburger.classList.contains('active')) {
        ...
        menuBody.classList.remove('active'); // если необходимо блокировать прокрутку фона (атрибут lock указать true)
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        modal.setAttribute('tabindex', '0'); // время выполнения ставится в соответствии с transition
