...
/* harmony import */ var _modules_menuBurger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/menuBurger */ "./src/js/modules/menuBurger.js");
...
/* harmony import */ var _modules_maskTelNumber__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/maskTelNumber */ "./src/js/modules/maskTelNumber.js");
/* harmony import */ var _modules_popup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/popup */ "./src/js/modules/popup.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_menuBurger__WEBPACK_IMPORTED_MODULE_1__["default"])('.menu', '.menu__link', '.hamburger', true);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_menuBurger__WEBPACK_IMPORTED_MODULE_1__["default"])('.info-header', '.info-header-tab', '.hamburger-info');
  ...
  Object(_modules_maskTelNumber__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_popup__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_modules_smoothScroll__WEBPACK_IMPORTED_MODULE_9__["default"])();
});
...
/***/ "./src/js/modules/focus.js":
/*!*********************************!*\
  !*** ./src/js/modules/focus.js ***!
  \*********************************/
/*! exports provided: blockFocus, unlockFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "blockFocus", function() { return blockFocus; });
...
var focusElements = ['a[href]', 'area[href]', 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', 'select:not([disabled]):not([aria-hidden])', 'textarea:not([disabled]):not([aria-hidden])', 'button:not([disabled]):not([aria-hidden])', 'iframe', 'object', 'embed', '[contenteditable]', '[tabindex]'];
var interactiveElements = [];
var blockElements = [];
function blockFocus(item) {
  var elements = document.querySelectorAll(focusElements.toString());
...
function unlockFocus() {
  if (interactiveElements.length !== 0) {
    var element = interactiveElements.pop();
    element.setAttribute('tabindex', '0');
  }

  if (blockElements.length !== 0) {
    var _element = blockElements.pop();

    _element.setAttribute('aria-gidden', 'false');
  }
}
;
...
var form = function form() {
  ...
  var inputs = document.querySelectorAll('input'); //==============Сообщения о ходе отправки==================
  ...
  function formAddError(item) {
    ...
    item.classList.add('error'); //! Оставить эту часть, если в html добавлены блоки с сообщением об ошибке (.form-error)
    //* если ошибка для каждого input

    var formError = item.nextElementSibling;
  ...
  function formRemoveError(selector) {
    if (selector.length > 0) {
      for (var index = 0; index < selector.length; index++) {
        ...
        input.classList.remove('error'); //! Оставить эту часть, если в html добавлены блоки с сообщением об ошибке (.form-error)

        var formError = input.nextElementSibling; // если ошибка для каждого input
...
/* harmony default export */ __webpack_exports__["default"] = (form); //*=========если необходимо отправлять данные на разные адреса======================
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _focus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./focus */ "./src/js/modules/focus.js");
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (fixScroll.length > 0) {
          fixScroll.forEach(function (item) {
        ...
        Object(_focus__WEBPACK_IMPORTED_MODULE_0__["blockFocus"])(modal);
      });
    });
    ...
    function popapClose() {
      ...
      Object(_focus__WEBPACK_IMPORTED_MODULE_0__["unlockFocus"])();
    }
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]]); // import Swiper from 'swiper/bundle';
