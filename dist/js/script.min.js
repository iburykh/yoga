...
/* harmony import */ var _modules_mouseparallax__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/mouseparallax */ "./src/js/modules/mouseparallax.js");
...
/* harmony import */ var _modules_maskTelNumber__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/maskTelNumber */ "./src/js/modules/maskTelNumber.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_menuBurger__WEBPACK_IMPORTED_MODULE_1__["default"])('.menu', '.menu__item', '.hamburger');
  Object(_modules_mouseparallax__WEBPACK_IMPORTED_MODULE_2__["default"])();
  ...
  Object(_modules_maskTelNumber__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_modules_popup__WEBPACK_IMPORTED_MODULE_9__["default"])();
});
...
var form = function form() {
    ...
    forms.forEach(function (item) {
      item.addEventListener('submit', function (e) {
        ...
        if (error === 0) {
          ...
          textMessage.textContent = message.loading; //=========FormData=====================================
          ...
          postData('../server.php', formData).then(function (res) {
            ...
            clearInputs();
            setTimeout(function () {
              textMessage.remove(); // item.style.display = 'block';
  ...
  function formAddError(item) {
    ...
    var formError = item.nextElementSibling; // если ошибка для каждого input
...
/***/ "./src/js/modules/mouseparallax.js":
/*!*****************************************!*\
  !*** ./src/js/modules/mouseparallax.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var mouseparallax = function mouseparallax() {
  var isMobile = {
  ...
  if (isMobile.any()) {
    ...
    window.onload = function () {
      var parallax = document.querySelector('.promo');
      ...
      if (parallax) {
        var setMouseParallaxStyle = function setMouseParallaxStyle() {
          ...
          fog.style.cssText = "transform: translate(".concat(positionX / forFog, "%,").concat(positionY / forFog, "%);");
          requestAnimationFrame(setMouseParallaxStyle);
        };

        var mountains = document.querySelector('.img-parallax-mountains');
        var fog = document.querySelector('.img-parallax-fog');
        var forMountains = 40;
        var forFog = 20;
        var speed = 0.05;
        var positionX = 0,
...
/* harmony default export */ __webpack_exports__["default"] = (mouseparallax);
      ...
      item.addEventListener('click', function (e) {
        ...
        if (fixScroll.length > 0) {
          fixScroll.forEach(function (item) {
            item.style.left = "-".concat(scroll, "px");
          });
        }
      });
    });
